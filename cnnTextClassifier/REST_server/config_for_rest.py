...
class RESTConfig():
    ...
    def __init__(self, run_number=None, doc_length=None, model_name="", checkpoint_dir="", transfer_learning=False, enable_char=False):

        self.runs_folder = "Runs/Account_Billing_v1"
    ...
    # dataset_name = "Project-A-R-Scenario_Billing_Account"
