...
class REST_Config():
    ...
    default_run_dir = default_dir+"Runs/Account_Billing_v2/"
    ...
    l1_tags_vocab = default_dir+"data/Project-A-R-Level-1_Billing_Account-v2/tags_vocab.txt"
    billing_tags_vocab = default_dir+"data/Project-A-R-Billing_Only-v1/tags_vocab_main.txt"
    account_tags_vocab = default_dir+"data/Project-A-R-Account_Only-v1/tags_vocab_main.txt"
