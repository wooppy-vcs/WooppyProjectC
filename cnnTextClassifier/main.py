...
if __name__ == "__main__":
    ...
    version = "v3-corrected-tags"

    model = {TextCNN: "CNNv0"}

    # dataset_name = {"Project-A-R-Scenario_Billing_Account-v2": "Scenario"}
    # dataset_name = {"Project-A-R-Level-1-ReducedtoOthers": "Level-1"}
    dataset_name = {"Project-A-R-Account_Only-v2": "Account_Only_Scenarios",
                    "Project-A-R-Billing_Only-v2": "Billing_Only_Scenarios"}
    ...
    for x in dataset_name:
        config = Config(dataset_name=x, version=version, classifier_type=dataset_name[x],
                        doc_length=40, model_name=model[TextCNN])
